 ...
 */
@Component
public class CommunityCreatedPerMonthTasklet implements Tasklet {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		for (Integer memberCount : teamMemberCreated) {
			...
			issueCount = (Integer) result.get("total_count") - memberCount;
		...
		report.put("community_created", values);
